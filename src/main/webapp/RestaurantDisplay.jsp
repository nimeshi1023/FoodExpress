            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                  ...
                  <img src="image/img1.jpg" alt="Admin Profile" style="width: 32px; height: 32px; border-radius: 50%; object-fit: cover; border: 1px solid #ccc;">
                    <span class="text-gray-700">silva</span>
            ...
            <main class="p-6">
                <div class="bg-white p-4 rounded-md shadow-md">
                    <div class="flex justify-between mb-4">
                        <h3 class="text-lg font-semibold">Restaurant Records</h3>
                       <button class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 flex items-center space-x-2" onclick="location.href='RestaurantInsert.jsp'">
                    ...
                    <table class="w-full border-collapse border border-gray-200">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="border border-gray-300 px-4 py-2">Email</th>
                                 <th class="border border-gray-300 px-6 py-2 ">Action</th>
                       ...
                       <c:forEach var="restaurant"  items="${allRestaurants}">
                        <tr>
                            ...
                            <td class="border border-gray-300 px-4 py-2">${restaurant.name}</td>
                            <td class="border border-gray-300 px-4 py-2">${restaurant.location}</td>
                            <td class="border border-gray-300 px-4 py-2">${restaurant.description}</td>
                            <td class="border border-gray-300 px-4 py-2">${restaurant.pno}</td>
                            <td class="border border-gray-300 px-4 py-2">${restaurant.email}</td>
                         
                            <td class="border border-gray-300 px-4 py-2 space-x-2">
                               <div class="action-buttons display-flex  gap-5px">
                            <a href="RestaurantUpdate.jsp?id=${restaurant.id}&name=${restaurant.name}&description=${restaurant.description}&location=${restaurant.location}&pno=${restaurant.pno}&email=${restaurant.email}">
