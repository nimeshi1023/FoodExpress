...
<div class="form-container">
  <h2 style= "color: #07611c">Update Delivery Person</h2>
  <form action="DeliveryUpdateServlet" method="post" id="deliveryForm">
    ...
    <select id="vehicleType" name="vehicleType" required>
      ...
      <option value="Bike" <%= vehicleType.equals("Bike") ? "selected" : "" %>>Bike</option>
      <option value="Three wheel" <%= vehicleType.equals("Three wheel") ? "selected" : "" %>>Three wheel</option>
    </select>
    
    <label for="licenNo">License Number</label>
    <input type="text" id="licenNo" name="licenNo" value="<%=licenNo%>"required>
